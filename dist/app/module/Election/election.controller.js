...
const createElection = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield election_service_1.ElectionService.createElectionIntoDB(req);
...
const getAllElections = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield election_service_1.ElectionService.getAllElections();
    (0, sendResponse_1.default)(res, {
        success: true,
